...
cadaoutput2_1.dx = cadaoutput2_1.dx(Gator1Data.Index8,1);
...
cada1tf2 = theta.f(Gator1Data.Index12);
...
cada1td1 = cada1td1(:);
temp.dx = cada1td1(Gator1Data.Index14);
temp.f = Gator1Data.Data1*cada1f2;
%User Line: temp                   = ones(3,1)*(sin(theta)./theta);
cada1tf1 = theta.f(Gator1Data.Index15);
cada1f1dx = -sin(cada1tf1(:)).*theta.dx;
cada1f1 = cos(theta.f);
cada1tf1 = nq_.f(Gator1Data.Index16);
cada1td1 = cada1tf1(:).*temp.dx;
cada1td1(Gator1Data.Index17) = cada1td1(Gator1Data.Index17) + temp.f(:).*nq_.dx;
cada1f2dx = cada1td1;
cada1f2 = temp.f.*nq_.f;
cada1td1 = zeros(360,1);
cada1td1(Gator1Data.Index18) = cada1f1dx;
cada1td1(Gator1Data.Index19) = cada1f2dx;
q.dx = cada1td1;
q.f = [cada1f1;cada1f2];
%User Line: q                      = [cos(theta); temp.*nq_];
cada1f1 = size(q.f,2);
cada1f2 = 2:cada1f1;
q_plus.dx = q.dx(Gator1Data.Index20);
q_plus.f = q.f(:,cada1f2);
%User Line: q_plus                 = q(:, 2:end);
cada1f1 = size(q.f,2);
cada1f2 = cada1f1 - 1;
cada1f3 = 1:cada1f2;
q_minus.dx = q.dx(Gator1Data.Index21);
q_minus.f = q.f(:,cada1f3);
%User Line: q_minus                = q(:, 1:end-1);
cada1tf1 = q_minus.f(Gator1Data.Index22);
cada1td1 = zeros(696,1);
cada1td1(Gator1Data.Index23) = cada1tf1(:).*q_plus.dx;
cada1tf1 = q_plus.f(Gator1Data.Index24);
cada1td1(Gator1Data.Index25) = cada1td1(Gator1Data.Index25) + cada1tf1(:).*q_minus.dx;
cada1f1dx = cada1td1;
cada1f1 = q_plus.f.*q_minus.f;
cada1td1 = zeros(4,174);
cada1td1(Gator1Data.Index26) = cada1f1dx;
...
cada1tf1 = qq.f(Gator1Data.Index27);
...
cada1tempdx = cadainput2_1.dx;
cadainput2_1.dx = zeros(279,1);
cadainput2_1.dx(Gator1Data.Index28,1) = cada1tempdx;
cadaoutput2_1 = ADiGator_normByCol(cadainput2_1);
% Call to function: normByCol
cadaoutput2_1.dx = cadaoutput2_1.dx(Gator1Data.Index29,1);
cada1td1 = zeros(1,90);
cada1td1(Gator1Data.Index30) = cadaoutput2_1.dx;
cada1td1 = Gator1Data.Data2*cada1td1;
cada1td1 = cada1td1(:);
cada1f1dx = cada1td1(Gator1Data.Index31);
cada1f1 = Gator1Data.Data2*cadaoutput2_1.f;
cada1tf1 = cada1f1(Gator1Data.Index32);
cada1td1 = Gax.dx./cada1tf1(:);
cada1tf1 = Gax.f(Gator1Data.Index33);
...
cada1f1dx = tempb.dx(Gator1Data.Index35);
cada1f1 = tempb.f(3,:);
cada1tf1 = cada1f1(Gator1Data.Index36);
...
cada1tf2 = cada1f1(Gator1Data.Index37);
...
%User Line: % Boundary
q_init.dx = q.dx(Gator1Data.Index38);
q_init.f = q.f(:,1);
%User Line: q_init          = q(:, 1);
cada1f1 = size(q.f,2);
q_final.dx = q.dx(Gator1Data.Index39);
q_final.f = q.f(:,cada1f1);
%User Line: q_final         = q(:, end);
cada1f1 = para_q0.';
cada1td1 = zeros(4,3);
cada1td1(Gator1Data.Index40) = q_init.dx;
...
cadainput5_1.f = Gator1Data.Data3 - q_final_ax.f;
...
cada1f1 = para_qf.';
cada1td1 = zeros(4,90);
cada1td1(Gator1Data.Index42) = q.dx;
cada1td1 = cada1f1*cada1td1;
cada1td1 = cada1td1(:);
cada1f2dx = cada1td1(Gator1Data.Index43);
cada1f2 = cada1f1*q.f;
cada1tf1 = cada1f2(Gator1Data.Index44);
...
cada1td1(Gator1Data.Index45) = CON_L_obj_ang_bt_frame.dx;
cada1td1(Gator1Data.Index46) = CON_L_tilt.dx;
CON_L.dx = cada1td1;
CON_L.f = [CON_L_obj_ang_bt_frame.f;CON_L_tilt.f];
%User Line: CON_L = [CON_L_obj_ang_bt_frame; CON_L_tilt];
cada1td1 = zeros(6,1);
cada1td1(Gator1Data.Index47) = CON_E_q_init.dx;
cada1td1(Gator1Data.Index48) = CON_E_q_final.dx;
CON_E.dx = cada1td1;
CON_E.f = [CON_E_q_init.f;CON_E_q_final.f];
%User Line: CON_E = [CON_E_q_init; CON_E_q_final];
cada1td1 = zeros(360,1);
cada1td1(Gator1Data.Index49) = COST.dx;
cada1td1(Gator1Data.Index50) = CON_L.dx;
cada1td1(Gator1Data.Index51) = CON_E.dx;
FUN.dx = cada1td1;
...
FUN.dx_size = [62,90];
FUN.dx_location = Gator1Data.Index52;
end
