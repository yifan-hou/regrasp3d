...
cada1tf1 = theta.f(Gator1Data.Index3);
...
cada1tf2 = theta.f(Gator1Data.Index6);
cada1td1 = cada1td1 + -cada1tf1(:)./cada1tf2(:).^2.*theta.dx;
cada1f2dx = cada1td1;
cada1f2 = cada1f1./theta.f;
cada1td1 = zeros(1,90);
cada1td1(Gator1Data.Index7) = cada1f2dx;
cada1td1 = Gator1Data.Data1*cada1td1;
cada1td1 = cada1td1(:);
temp.dx = cada1td1(Gator1Data.Index8);
...
cada1f1 = cos(theta.f);
cada1tf1 = nq_.f(Gator1Data.Index10);
cada1td1 = cada1tf1(:).*temp.dx;
cada1td1(Gator1Data.Index11) = cada1td1(Gator1Data.Index11) + temp.f(:).*nq_.dx;
cada1f2dx = cada1td1;
cada1f2 = temp.f.*nq_.f;
cada1td1 = zeros(360,1);
cada1td1(Gator1Data.Index12) = cada1f1dx;
...
cada1f1 = size(q.f,2);
cada1f2 = 2:cada1f1;
q_plus.dx = q.dx(Gator1Data.Index14);
q_plus.f = q.f(:,cada1f2);
%User Line: q_plus                 = q(:, 2:end);
cada1f1 = size(q.f,2);
cada1f2 = cada1f1 - 1;
cada1f3 = 1:cada1f2;
q_minus.dx = q.dx(Gator1Data.Index15);
q_minus.f = q.f(:,cada1f3);
%User Line: q_minus                = q(:, 1:end-1);
cada1tf1 = q_minus.f(Gator1Data.Index16);
cada1td1 = zeros(696,1);
cada1td1(Gator1Data.Index17) = cada1tf1(:).*q_plus.dx;
cada1tf1 = q_plus.f(Gator1Data.Index18);
cada1td1(Gator1Data.Index19) = cada1td1(Gator1Data.Index19) + cada1tf1(:).*q_minus.dx;
cada1f1dx = cada1td1;
cada1f1 = q_plus.f.*q_minus.f;
cada1td1 = zeros(4,174);
cada1td1(Gator1Data.Index20) = cada1f1dx;
...
cada1tf1 = qq.f(Gator1Data.Index21);
...
% Call to function: normByCol
cada1td1 = zeros(1,90);
cada1td1(Gator1Data.Index22) = cadaoutput2_1.dx;
cada1td1 = Gator1Data.Data3*cada1td1;
cada1td1 = cada1td1(:);
cada1f1dx = cada1td1(Gator1Data.Index23);
cada1f1 = Gator1Data.Data3*cadaoutput2_1.f;
cada1tf1 = cada1f1(Gator1Data.Index24);
cada1td1 = Gax.dx./cada1tf1(:);
cada1tf1 = Gax.f(Gator1Data.Index25);
cada1tf2 = cada1f1(Gator1Data.Index26);
cada1td1 = cada1td1 + -cada1tf1(:)./cada1tf2(:).^2.*cada1f1dx;
tempb.dx = cada1td1;
tempb.f = Gax.f./cada1f1;
%User Line: tempb        = Gax./(ones(3,1)*cadaoutput2_1);
cada1f1dx = tempb.dx(Gator1Data.Index27);
cada1f1 = tempb.f(3,:);
...
%User Line: % Boundary
q_init.dx = q.dx(Gator1Data.Index30);
q_init.f = q.f(:,1);
%User Line: q_init        = q(:, 1);
cada1f1 = size(q.f,2);
q_final.dx = q.dx(Gator1Data.Index31);
q_final.f = q.f(:,cada1f1);
%User Line: q_final       = q(:, end);
cada1f1 = para_q0.';
cada1td1 = zeros(4,3);
cada1td1(Gator1Data.Index32) = q_init.dx;
cada1td1 = cada1f1*cada1td1;
cada1td1 = cada1td1(:);
cada1f2dx = cada1td1(Gator1Data.Index33);
...
cada1f1 = para_qf.';
cada1td1 = zeros(4,3);
cada1td1(Gator1Data.Index34) = q_final.dx;
cada1td1 = cada1f1*cada1td1;
cada1td1 = cada1td1(:);
cada1f2dx = cada1td1(Gator1Data.Index35);
...
cada1f1 = para_qf.';
cada1td1 = zeros(4,90);
cada1td1(Gator1Data.Index36) = q.dx;
cada1td1 = cada1f1*cada1td1;
cada1td1 = cada1td1(:);
cada1f2dx = cada1td1(Gator1Data.Index37);
cada1f2 = cada1f1*q.f;
...
cada1td1(Gator1Data.Index39) = CON_L_obj_ang_bt_frame.dx;
cada1td1(Gator1Data.Index40) = CON_L_tilt.dx;
CON_L.dx = cada1td1;
CON_L.f = [CON_L_obj_ang_bt_frame.f;CON_L_tilt.f];
%User Line: CON_L = [CON_L_obj_ang_bt_frame; CON_L_tilt];
cada1td1 = zeros(6,1);
cada1td1(Gator1Data.Index41) = CON_E_q_init.dx;
cada1td1(Gator1Data.Index42) = CON_E_q_final.dx;
CON_E.dx = cada1td1;
CON_E.f = [CON_E_q_init.f;CON_E_q_final.f];
%User Line: CON_E = [CON_E_q_init; CON_E_q_final];
cada1td1 = zeros(360,1);
cada1td1(Gator1Data.Index43) = COST.dx;
cada1td1(Gator1Data.Index44) = CON_L.dx;
cada1td1(Gator1Data.Index45) = CON_E.dx;
FUN.dx = cada1td1;
...
%User Line: %
%User Line: % save snoptfiles/sizeInfo1.mat Flow Fupp xlow xupp
FUN.dx_size = [62,90];
FUN.dx_location = Gator1Data.Index46;
end
