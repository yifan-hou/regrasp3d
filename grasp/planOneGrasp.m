function [plan, qp] = planOneGrasp(mesh, gp1o_w, gp2o_w, q0, qf, pgraph, para )
...
[object_plan, init_grasp_ang] = plan2DObject(gravity_2d, graspfpz_2d, COMp_2d, pointsp_2d, ... 
...
% 	Animation
% -----------------------------------------
if para.show2DAnimation
	animatePlan(mesh, para.show2DAnimation_id, gp10p_w, gp20p_w, qgrasp0p_w, COM0p_w, points0p_w, plan);
end
